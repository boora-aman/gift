  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Search Interest Shows</h3>
        ...
        <div class="px-6 py-4 border-b border-gray-200">
          <div class="flex justify-between items-center">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white">
              Interest Records ({{ totalRecords }} total)
            </h3>
            <div class="flex items-center space-x-4">
              ...
              <select v-model="sortBy" @change="applyFilters"
                ...
                <option value="date">Sort by Interest Date</option>
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tr v-else v-for="record in reportData" :key="record.interest_id">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                  {{ formatDate(record.interest_date) }}
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div>
  ...
  methods: {
    ...
    async loadReport() {
      ...
      try {
        ...
        const result = await ReportsAPI.getInterestShowsReport(params)
    ...
    async exportReport() {
      ...
      try {
        ...
        exportToExcel(result.data, columns, 'Interest_Shows_Report')
